...
import com.wurq.dex.monitorapp.util.OfflineMode;
 ...
 *
 * <dl>
 *     <dt>com.wurq.dex.monitorapp.MPConfig.EnableDebugLogging</dt>
 *     <dd>A boolean value. If true, emit more detailed log messages. Defaults to false</dd>
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.BulkUploadLimit</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.DataExpiration</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.MinimumDatabaseLimit</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.DisableFallback</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.ResourcePackageName</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.DisableGestureBindingUI</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.DisableEmulatorBindingUI</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.DisableAppOpenEvent</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.AutoShowMixpanelUpdates</dt>
 *     <dd>A boolean value. If true, automatically show surveys, notifications, and A/B test variants. Defaults to true.</dd>
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.EventsEndpoint</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.EventsFallbackEndpoint</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.PeopleEndpoint</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.PeopleFallbackEndpoint</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.DecideEndpoint</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.DecideFallbackEndpoint</dt>
 ...
 *
 *     <dt>com.wurq.dex.monitorapp.MPConfig.EditorUrl</dt>
...
public class MPConfig {
    ...
    /* package */ static final String REFERRER_PREFS_NAME = "com.wurq.dex.monitorapp.mpmetrics.ReferralInfo";
    ...
    /* package */ MPConfig(Bundle metaData, Context context) {
        ...
        DEBUG = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.EnableDebugLogging", false);

        if (metaData.containsKey("com.wurq.dex.monitorapp.MPConfig.AutoCheckForSurveys")) {
            Log.w(LOGTAG, "com.wurq.dex.monitorapp.MPConfig.AutoCheckForSurveys has been deprecated in favor of " +
                          "com.wurq.dex.monitorapp.MPConfig.AutoShowMixpanelUpdates. Please update this key as soon as possible.");
        }
        if (metaData.containsKey("com.wurq.dex.monitorapp.MPConfig.DebugFlushInterval")) {
            Log.w(LOGTAG, "We do not support com.wurq.dex.monitorapp.MPConfig.DebugFlushInterval anymore. There will only be one flush interval. Please, update your AndroidManifest.xml.");
        }

        mBulkUploadLimit = metaData.getInt("com.wurq.dex.monitorapp.MPConfig.BulkUploadLimit", 40); // 40 records default
        mFlushInterval = metaData.getInt("com.wurq.dex.monitorapp.MPConfig.FlushInterval", 60 * 1000); // one minute default
        mDataExpiration = metaData.getInt("com.wurq.dex.monitorapp.MPConfig.DataExpiration", 1000 * 60 * 60 * 24 * 5); // 5 days default
        mMinimumDatabaseLimit = metaData.getInt("com.wurq.dex.monitorapp.MPConfig.MinimumDatabaseLimit", 20 * 1024 * 1024); // 20 Mb
        mDisableFallback = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.DisableFallback", true);
        mResourcePackageName = metaData.getString("com.wurq.dex.monitorapp.MPConfig.ResourcePackageName"); // default is null
        mDisableGestureBindingUI = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.DisableGestureBindingUI", false);
        mDisableEmulatorBindingUI = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.DisableEmulatorBindingUI", false);
        mDisableAppOpenEvent = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.DisableAppOpenEvent", true);
        mDisableViewCrawler = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.DisableViewCrawler", false);
        mDisableDecideChecker = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.DisableDecideChecker", false);
        mImageCacheMaxMemoryFactor = metaData.getInt("com.wurq.dex.monitorapp.MPConfig.ImageCacheMaxMemoryFactor", 10);

        // Disable if EITHER of these is present and false, otherwise enable
        final boolean surveysAutoCheck = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.AutoCheckForSurveys", true);
        final boolean mixpanelUpdatesAutoShow = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.AutoShowMixpanelUpdates", true);
        mAutoShowMixpanelUpdates = surveysAutoCheck && mixpanelUpdatesAutoShow;

        mTestMode = metaData.getBoolean("com.wurq.dex.monitorapp.MPConfig.TestMode", false);

        String eventsEndpoint = metaData.getString("com.wurq.dex.monitorapp.MPConfig.EventsEndpoint");
        if (null == eventsEndpoint) {
            eventsEndpoint = "https://api.mixpanel.com/track?ip=1";
        }
        mEventsEndpoint = eventsEndpoint;

        String eventsFallbackEndpoint = metaData.getString("com.wurq.dex.monitorapp.MPConfig.EventsFallbackEndpoint");
        ...
        String peopleEndpoint = metaData.getString("com.wurq.dex.monitorapp.MPConfig.PeopleEndpoint");
        if (null == peopleEndpoint) {
            peopleEndpoint = "https://api.mixpanel.com/engage";
        }
        mPeopleEndpoint = peopleEndpoint;

        String peopleFallbackEndpoint = metaData.getString("com.wurq.dex.monitorapp.MPConfig.PeopleFallbackEndpoint");
        ...
        String decideEndpoint = metaData.getString("com.wurq.dex.monitorapp.MPConfig.DecideEndpoint");
        if (null == decideEndpoint) {
            decideEndpoint = "https://decide.mixpanel.com/decide";
        }
        mDecideEndpoint = decideEndpoint;

        String decideFallbackEndpoint = metaData.getString("com.wurq.dex.monitorapp.MPConfig.DecideFallbackEndpoint");
        ...
        String editorUrl = metaData.getString("com.wurq.dex.monitorapp.MPConfig.EditorUrl");
        if (null == editorUrl) {
            editorUrl = "wss://switchboard.mixpanel.com/connect/";
        }
        mEditorUrl = editorUrl;

        int resourceId = metaData.getInt("com.wurq.dex.monitorapp.MPConfig.DisableViewCrawlerForProjects", -1);
        if (resourceId != -1) {
