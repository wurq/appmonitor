...
import com.wurq.dex.monitorapp.util.Base64Coder;
import com.wurq.dex.monitorapp.util.HttpService;
import com.wurq.dex.monitorapp.util.RemoteService;
...
/* package */ class AnalyticsMessages {
    ...
    class Worker {
        ...
        protected Handler restartWorkerThread() {
            final HandlerThread thread = new HandlerThread("com.wurq.dex.monitorapp.AnalyticsWorker", Thread.MIN_PRIORITY);
            thread.start();
