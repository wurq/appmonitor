...
public class CardCarouselLayout extends ViewGroup {
    ...
    private static class ChoiceAdapter implements ListAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TextView choiceText = (TextView) convertView.findViewById(R.id.com_wurq_dex_monitorapp_multiple_choice_answer_text);
    ...
    private class QuestionCard {
        ...
        public QuestionCard(final View cardView) {
            mCardView = cardView;
            mPromptView = (TextView) cardView.findViewWithTag("com.wurq.dex.monitorapp_TAG_prompt_text");
            mEditAnswerView = (EditText) cardView.findViewWithTag("com.wurq.dex.monitorapp_TAG_text_answer");
            mChoiceView = (ListView) cardView.findViewWithTag("com.wurq.dex.monitorapp_TAG_choice_list");
