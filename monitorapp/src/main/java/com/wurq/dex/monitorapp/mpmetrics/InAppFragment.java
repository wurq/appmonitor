...
public class InAppFragment extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        mDisplayMini = new Runnable() {
            ...
            public void run() {
                ...
                final ImageView notifImage = (ImageView) mInAppView.findViewById(R.id.com_wurq_dex_monitorapp_notification_image);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (null == mDisplayState) {
            ...
            final TextView titleView = (TextView) mInAppView.findViewById(R.id.com_wurq_dex_monitorapp_notification_title);
            final ImageView notifImage = (ImageView) mInAppView.findViewById(R.id.com_wurq_dex_monitorapp_notification_image);
    ...
    private void showLightStyle() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            viewBackground.setStroke(2, getResources().getColor(R.color.com_wurq_dex_monitorapp_inapp_light_softgray));
            titleView.setTextColor(getResources().getColor(R.color.com_wurq_dex_monitorapp_inapp_light_gray));
        } else {
            viewBackground.setStroke(2, getResources().getColor(R.color.com_wurq_dex_monitorapp_inapp_light_softgray, null));
            titleView.setTextColor(getResources().getColor(R.color.com_wurq_dex_monitorapp_inapp_light_gray, null));
        }
        ...
        final int newColor;
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            newColor = getResources().getColor(R.color.com_wurq_dex_monitorapp_inapp_light_gray);
        } else {
            newColor = getResources().getColor(R.color.com_wurq_dex_monitorapp_inapp_light_gray, null);
        }
