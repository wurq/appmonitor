...
import com.wurq.dex.monitorapp.surveys.SurveyActivity;
import com.wurq.dex.monitorapp.util.ActivityImageUtils;
import com.wurq.dex.monitorapp.viewcrawler.TrackingDebug;
import com.wurq.dex.monitorapp.viewcrawler.UpdatesFromMixpanel;
import com.wurq.dex.monitorapp.viewcrawler.ViewCrawler;
...
public class MixpanelAPI {
     ...
     *
     * @deprecated in 4.0.0, use com.wurq.dex.monitorapp.MPConfig.FlushInterval application metadata instead
     */
    @Deprecated
    public static void setFlushInterval(Context context, long milliseconds) {
        Log.i(
            ...
            "    <meta-data android:name=\"com.wurq.dex.monitorapp.MPConfig.FlushInterval\" android:value=\"YOUR_INTERVAL\" />\n" +
     ...
     *
     * @deprecated in 4.0.0, use com.wurq.dex.monitorapp.MPConfig.EventsFallbackEndpoint, com.wurq.dex.monitorapp.MPConfig.PeopleFallbackEndpoint, or com.wurq.dex.monitorapp.MPConfig.DecideFallbackEndpoint instead
     */
    @Deprecated
    public static void enableFallbackServer(Context context, boolean enableIfTrue) {
        Log.i(
            ...
            "    <meta-data android:name=\"com.wurq.dex.monitorapp.MPConfig.DisableFallback\" android:value=\"false\" />\n" +
            "    to the <application> section of your AndroidManifest.xml."
        );
    }
    ...
    public interface People {
         ...
         * <pre>
         * {@code
         * <receiver android:name="com.wurq.dex.monitorapp.mpmetrics.GCMReceiver"
         ...
         *
         * @see com.wurq.dex.monitorapp.mpmetrics.GCMReceiver
         ...
         * {@code
         *     <meta-data android:name="com.wurq.dex.monitorapp.MPConfig.AutoShowMixpanelUpdates"
         *                android:value="false" />
         * }
         *
         ...
         *
         * @param notif the {@link com.wurq.dex.monitorapp.mpmetrics.InAppNotification} to show
         *
         * @param parent the Activity that the mini notification will be displayed in, or the Activity
         * that will be used to launch SurveyActivity for the takeover notification.
         */
         ...
         *
         * @param notif the {@link com.wurq.dex.monitorapp.mpmetrics.InAppNotification} associated with the event you'd like to track.
         */
         ...
         * receive the same {@link com.wurq.dex.monitorapp.mpmetrics.InAppNotification} again the
        ...
        /**
         * Tells MixPanel that you have handled an {@link com.wurq.dex.monitorapp.mpmetrics.InAppNotification}
     ...
     * {@code
     * <meta-data android:name="com.wurq.dex.monitorapp.MPConfig.EnableDebugLogging" />
     * }
     *
    ...
    public void logPosts() {
        Log.i(
                ...
                "MixpanelAPI.logPosts() is deprecated.\n" +
                        ...
                        "    <meta-data android:name=\"com.wurq.dex.monitorapp.MPConfig.EnableDebugLogging\" value=\"true\" />\n" +
                        "    to the <application> section of your AndroidManifest.xml."
        );
    }
     ...
     * com.wurq.dex.monitorapp.MPConfig.AutoShowMixpanelUpdates to false in your AndroidManifest.xml
     *
     * This function is automatically called when the library is initialized unless you explicitly
     * set com.wurq.dex.monitorapp.MPConfig.AutoShowMixpanelUpdates to false in your AndroidManifest.xml
     */
    ...
    /* package */ PersistentIdentity getPersistentIdentity(final Context context, Future<SharedPreferences> referrerPreferences, final String token) {
        ...
        final String prefsName = "com.wurq.dex.monitorapp.mpmetrics.MixpanelAPI_" + token;
        final Future<SharedPreferences> storedPreferences = sPrefsLoader.loadPreferences(context, prefsName, listener);

        final String timeEventsPrefsName = "com.wurq.dex.monitorapp.mpmetrics.MixpanelAPI.TimeEvents_" + token;
...
//                                transaction.setCustomAnimations(0, R.anim.com.wurq.dex.monitorapp_slide_down);
//                                        .com.wurq.dex.monitorapp_slide_down);
//                                        com.wurq.dex.monitorapp_slide_down);
//                                        com.wurq.dex);
